...
export const metadata: Metadata = {
  ...
  description:
    "Olleik Foods delivers restaurant-grade ingredients with personalized catalogs, transparent pricing, and on-schedule delivery for restaurants, cafés, and small businesses.",
};
